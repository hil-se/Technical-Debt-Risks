...
class techdebt_cnn:
    ...
    def get_data(self):
        d1=pd.read_csv("data/jruby-1.4.0.csv")
        d2=pd.read_csv("data/jEdit-4.2.csv")
        d3=pd.read_csv("data/jfreechart-1.0.19.csv")
        d4=pd.read_csv("data/sql12.csv")
        d5=pd.read_csv("data/apache-ant-1.7.0.csv")
        d6=pd.read_csv("data/argouml.csv")
        d7=pd.read_csv("data/columba-1.4-src.csv")
        d8=pd.read_csv("data/emf-2.4.1.csv")
        d9=pd.read_csv("data/hibernate-distribution-3.3.2.GA.csv")
    ...
    def preprocess(self):
        ...
        return word_index,tokenizer, X_train, X_val, y_train, y_val
    ...
    def get_embeddings(self):
        ...
        word_index,tokenizer,X_train, X_val, y_train, y_val=self.preprocess()
        ...
        return embedding_matrix, word_index, tokenizer, X_train, X_val, y_train, y_val
    ...
    def build_model(self):
        ...
        embedding_matrix,word_index, tokenizer, X_train, X_val, y_train, y_val =self.get_embeddings()
        ...
        model.save( "corr6_nl_r0d0op0.h5")
        ...
        #self.show()
        #import tensorflow as tf
        dtest=pd.read_csv("data/apache-jmeter-2.10.csv")
